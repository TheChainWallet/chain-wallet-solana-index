            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="mt-16 flex justify-center">
                    <div className="relative">
                        ...
                        <div className="absolute -top-2 -right-2 w-6 h-6 rounded-full bg-gradient-brand flex items-center justify-center">
                            <svg xmlns="http://www.w3.org/2000/svg" className="w-3 h-3 text-[hsl(var(--background))]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
